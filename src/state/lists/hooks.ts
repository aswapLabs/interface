import DEFAULT_TOKEN_LIST from '../../constants/aswap-default.tokenlist.json'
import { TokenList } from '@uniswap/token-lists'
import { useMemo } from 'react'
import { useAppSelector } from 'state/hooks'
import sortByListPriority from 'utils/listSort'
import UNSUPPORTED_TOKEN_LIST from '../../constants/tokenLists/aswap-unsupported.tokenlist.json'
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    // [SupportedChainId.LOCAL]: { ...map1[SupportedChainId.LOCAL], ...map2[SupportedChainId.LOCAL] },
