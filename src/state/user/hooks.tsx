import { Percent, Token } from '@aswaporg/aswap-sdk-core'
...
import { PINNED_PAIRS } from '../../constants/routing'
...
// export function toV2LiquidityToken(tokens: Token[]): Token {
...
//   const tokenB = tokens[1]
  ...
  // console.log("total66600:", tokenA, tokenB, Pair.getAddress(tokenA, tokenB))
  return new Token(
    tokenA.chainId,
      computePairAddress1({tokenA, tokenB}),
    9, //默认为9
    'LiquidityToken',
    'AswapLPT'
  )
...
export const computePairAddress1 = ({
                                     tokenA,
                                     tokenB
                                   }: {
  tokenA: Token
  ...
  return `0x9bb5ace47e68616f64229b119f4c5d95::LiquidityToken::LiquidityToken<${tokenA.address}, ${tokenB.address}>`
}
