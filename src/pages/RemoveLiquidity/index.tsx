...
import {useTokenDecimals2} from "../../hooks/useTokenSwapRouter";
...
export default function RemoveLiquidity({
  ...
  const {data:currencyA} = useTokenDecimals2(currencyIdA)
  const {data:currencyB} = useTokenDecimals2(currencyIdB)
