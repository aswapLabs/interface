...
import zh from '../../assets/images/zh@3x.png'
                ...
                <Wrapper id="swap-page">
                    ...
                    <AutoColumn gap={'md'}>
                        <div style={{ display: 'relative' }}>
                            <CurrencyInputPanel
                                label={
                                    independentField === Field.OUTPUT && !showWrap ? <Trans>From (at most)</Trans> :
                                        <Trans>From</Trans>
                                }
                            ...
                            <CurrencyInputPanel
                                ...
                                label={independentField === Field.INPUT && !showWrap ? <Trans>To (at least)</Trans> :
                                    <Trans>To</Trans>}
                                showMaxButton={false}
                                hideBalance={false}
                                ...
                                <GreyCard style={{ textAlign: 'center' }}>
                                    <TYPE.main mb="4px">
                                        {isLoadingRoute ? (
                                            ...
                                            <Trans>Insufficient liquidity for this trade. Try enabling multi-hop
                                                trades.</Trans>
                                        ) : (
                                            ...
                                            <AutoRow justify="space-between" style={{ flexWrap: 'nowrap' }}>
                                                ...
                                                {approvalState === ApprovalState.PENDING ? (
                                                    ...
                                                    <MouseoverTooltip
                                                        text={
                                                            <Trans>
                                                                You must give the Uniswap smart contracts permission to
                                                                use your{' '}
                                                                {currencies[Field.INPUT]?.symbol}. You only have to do
                                                                this once per token.
                                                            </Trans>
                                                        }
                                                    >
