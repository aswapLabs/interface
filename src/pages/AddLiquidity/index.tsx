...
export default function AddLiquidity({
  ...
  const handleCurrencyASelect = useCallback(
    (currencyANew: Currency) => {
      ...
      if (idB === undefined) {
        history.push(`/add/v1/${idA}`)
      } else {
        history.push(`/add/v1/${idA}/${idB}`)
      }
    },
  ...
  const handleFeePoolSelect = useCallback(
    (newFeeAmount: FeeAmount) => {
      history.push(`/add/v1/${currencyIdA}/${currencyIdB}/${newFeeAmount}`)
    },
                          ...
                          {baseCurrency && quoteCurrency ? (
                            <RateToggle
                              ...
                              handleRateToggle={() => {
                                ...
                                onRightRangeInput('')
                                history.push(
                                  `/add/v1/${currencyIdB as string}/${currencyIdA as string}${
                                    feeAmount ? '/' + feeAmount : ''
                                  }`
                                )
                              }}
